  ...
  const handleSubmit = async (e) => {
    ...
    if (newChain) {
      ...
      const correspondingLabelA4 = (index) => {
        ...
        // Object.entries(finalData.content.content).find(([key, value]) => {
        //     if (value.type === "label") {
        //         console.log("possible")
        //         console.log(value.userClusterIndexA4)
        //         if (value.userClusterIndexA4 === index) {
        //             console.log("yay")
